<?php
/**
 * Plugin Name: Theme Section Block
 * Description: <strong><a href="https://webackstop.com">Theme Section Block</a></strong> is a custom Gutenberg Blocks that is specially developed for designing theme sections easily.
...
function gmtb_blocks_init(){
    ...
    // gmtb_register_block('hero-block');
    gmtb_register_block('section-block');
    // gmtb_register_block('advanced-button');
